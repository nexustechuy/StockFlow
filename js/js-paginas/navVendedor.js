function crearNavbarMovil() {
  ...
  const paginaActual = window.location.pathname.split('/').pop() || 'dashboardVendedor.html';
  ...
  const html = `
    ...
    <div class="menu-movil" id="menuMovil">
      ...
      <a href="dashboardVendedor.html" onclick="cerrarMenu()">Dashboard</a>
      <a href="#" onclick="cerrarMenu()">Registrar venta</a>
      <a href="#" onclick="cerrarMenu()">Productos</a>
      <a href="#" onclick="cerrarMenu()">Historial</a>
