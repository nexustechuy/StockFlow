function crearNavbarMovil() {
  ...
  const paginaActual = window.location.pathname.split('/').pop() || 'dashboardRepositor.html';
  ...
  const html = `
    ...
    <div class="menu-movil" id="menuMovil">
      ...
      <a href="dashboardRepositor.html" onclick="cerrarMenu()">Dashboard</a>
      <a href="#" onclick="cerrarMenu()">Productos</a>
      <a href="#" onclick="cerrarMenu()">Reposiciones</a>
      <a href="#" onclick="cerrarMenu()">Alerta de Stock</a>
